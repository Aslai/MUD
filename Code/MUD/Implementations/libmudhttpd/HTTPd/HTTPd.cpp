...
#include "libmudcommon/Filesystem/Filesystem.hpp"
#include "libmudcommon/Filesystem/MIME.hpp"
...
namespace MUD{
        DLL_EXPORT std::string HTTPd::URLDecode(std::string url){
            std::string ret = "";
            char escape;
            bool escaped = false;
            int escapelevel = 0;
        ...
        DLL_EXPORT bool HTTPd::RunTests(){
            TEST("MUD::HTTPd");
        ...
        DLL_EXPORT Error HTTPd::SetFileHandler( std::string extension, std::function<HTTPResponse(HTTPResponse response, HTTPd& parent, std::string localpath)> func ){
            FileHandler f;
        ...
        DLL_EXPORT Error HTTPd::SetDefaultIndex( std::string value ){
            DefaultIndex = value;
            return Error::None;
        }

        DLL_EXPORT void HTTPd::ConnectionHandler(CommStream stream, void* parent ){
        ...
        DLL_EXPORT void HTTPd::HTTPResponse::SetContent(std::string value){
            content.resize(value.size());
            memcpy( &(content[0]), value.c_str(), value.length() );
        }

        DLL_EXPORT HTTPd::HTTPResponse& HTTPd::HTTPResponse::operator+=(HTTPd::HTTPResponse other){
            status = other.status;
        ...
        DLL_EXPORT HTTPd::HTTPResponse HTTPd::DoError(HTTPResponse response, HTTPd& parent, int code){
        ...
        DLL_EXPORT Error HTTPd::MountFolder(std::string mountpath, std::string folderpath){
            return MountDirectory( mountpath, folderpath );
        }

        DLL_EXPORT HTTPd::HTTPResponse HTTPd::PushPage( HTTPd::HTTPResponse r, std::string mount2 ){
        ...
        DLL_EXPORT Error HTTPd::MountDirectory(std::string mountpath, std::string folderpath){
            MountPoint m;
        ...
        DLL_EXPORT Error HTTPd::MountFile(std::string mountpath, std::string filepath){
            MountPoint m;
        ...
        DLL_EXPORT Error HTTPd::MountFunction(std::string mountpath, std::function<HTTPResponse(HTTPResponse response, HTTPd& parent)> func ){
            MountPoint m;
        ...
        DLL_EXPORT HTTPd::HTTPd(std::string address, int port){
            Address = address;
            Port = port;
            stream = nullptr;
            MyThread = nullptr;
