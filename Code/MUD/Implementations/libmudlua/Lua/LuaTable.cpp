...
DLL_EXPORT Lua::Table::Table( lua_State *Lua, const char* name ) :
    globalname(name),
    ref(-1),
    L(Lua)
{
...
DLL_EXPORT Lua::Table::Table( lua_State *Lua, int reference ) :
    globalname(""),
    ref(reference),
    L(Lua)
{
...
DLL_EXPORT Lua::Table::Table( ) :
    globalname(""),
    ref(-1),
    L(0){
    p.L = L;
}
DLL_EXPORT Lua::Table& Lua::Table::operator=(Lua::Table f){
...
DLL_EXPORT size_t Lua::Table::Length(){
